...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return _iceI_avgAsync(a, context, true).waitForResponse();
    }
    ...
    default double calculateLagrange(int x, java.util.Map<java.lang.Integer, int[]> c)
        throws InvalidInput,
               ZeroDivisionError
    {
        return calculateLagrange(x, c, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double calculateLagrange(int x, java.util.Map<java.lang.Integer, int[]> c, java.util.Map<String, String> context)
        throws InvalidInput,
               ZeroDivisionError
    {
        try
        {
            return _iceI_calculateLagrangeAsync(x, c, context, true).waitForResponseOrUserEx();
        }
        catch(InvalidInput ex)
        {
            throw ex;
        }
        catch(ZeroDivisionError ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Double> calculateLagrangeAsync(int x, java.util.Map<java.lang.Integer, int[]> c)
    {
        return _iceI_calculateLagrangeAsync(x, c, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> calculateLagrangeAsync(int x, java.util.Map<java.lang.Integer, int[]> c, java.util.Map<String, String> context)
    {
        return _iceI_calculateLagrangeAsync(x, c, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_calculateLagrangeAsync(int iceP_x, java.util.Map<java.lang.Integer, int[]> iceP_c, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "calculateLagrange", null, sync, _iceE_calculateLagrange);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_x);
                     CoefficientsHelper.write(ostr, iceP_c);
                 }, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
    ...
    /** @hidden */
    static final Class<?>[] _iceE_calculateLagrange =
    {
        InvalidInput.class,
